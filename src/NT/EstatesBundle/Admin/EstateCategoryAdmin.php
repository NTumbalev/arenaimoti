...
/**
 *  Admin class for EstateCategory
 *
...
class EstateCategoryAdmin extends Admin
{
    ...
    public function configureFormFields(FormMapper $formMapper)
    {
        ...
        $translationAdmin = $this->configurationPool->getAdminByAdminCode('nt.estates.admin.estate_category_translations');
