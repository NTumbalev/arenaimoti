...
/**
 *  Entity holding Attribute's translations
 *
 * @ORM\Entity
 * @ORM\Table(name="attributes_i18n", uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx", columns={
 *     "locale", "object_id"
...
{
    /**
     * @ORM\ManyToOne(targetEntity="NT\EstatesBundle\Entity\Attribute", inversedBy="translations")
