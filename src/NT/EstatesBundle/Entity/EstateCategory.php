 ...
 * Estate's entity
 *
 * @ORM\Table(name="estate_categories")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="EstateCategoryRepository")
 * @Gedmo\Loggable
 ...
 */
class EstateCategory implements PublishWorkflowInterface, SeoAwareInterface
{
    use SeoAwareTrait;
    ...
    */
     ...
     * @Gedmo\Versioned
     * @Gedmo\TreeParent
     * @ORM\ManyToOne(targetEntity="EstateCategory", inversedBy="children")
     * @ORM\JoinColumn(name="parent_id", referencedColumnName="id", onDelete="CASCADE")
     */
    protected $parent;

    /**
     * @ORM\OneToMany(targetEntity="EstateCategory", mappedBy="parent")
     * @ORM\OrderBy({"lft" = "ASC"})
     */
    protected $children;
    ...
    /**
     * @ORM\OneToMany(targetEntity="NT\EstatesBundle\Entity\Estate", mappedBy="estateCategories")
     */
    protected $estates;
    ...
    /**
     * @ORM\OneToMany(targetEntity="NT\EstatesBundle\Entity\EstateCategoryTranslation", mappedBy="object", cascade={"persist", "remove"}, indexBy="locale")
     */
    ...
    public function getRoute()
    {
        if ($this->getChildren()->filter(function($item){
            ...
            return 'estates_categories_category_view';
        } else {
            return 'estates_categories_list';
        }
    }
    ...
    /**
     * Sets the value of estates.
     *
     * @param mixed $estates the estates
     *
     * @return self
     */
