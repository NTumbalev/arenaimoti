...
/**
 *  Entity holding EstateCategory's translations
 *
 * @ORM\Entity
 * @ORM\Table(name="estate_categories_i18n", uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx", columns={
 *     "locale", "object_id"
 ...
 */
class EstateCategoryTranslation extends AbstractTranslation
{
    /**
     * @ORM\ManyToOne(targetEntity="NT\EstatesBundle\Entity\EstateCategory", inversedBy="translations")
