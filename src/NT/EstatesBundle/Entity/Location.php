...
class Location implements PublishWorkflowInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="NT\EstatesBundle\Entity\Estate", mappedBy="location")
     */
    protected $estates;
    ...
    /**
     * @ORM\OneToMany(targetEntity="NT\EstatesBundle\Entity\LocationTranslation", mappedBy="object", cascade={"persist", "remove"}, indexBy="locale")
     */
